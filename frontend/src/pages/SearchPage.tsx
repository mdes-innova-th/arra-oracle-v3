...
function SearchInputCard({ query, loading, onQueryChange, onSubmit }: {
  ...
  return (
    <section className="glass rounded-3xl border border-[oklch(1_0_0/0.08)] bg-[oklch(0.16_0.02_265/0.35)] shadow-[0_8px_32px_oklch(0_0_0/0.4)] backdrop-blur-xl p-5 sm:p-6" aria-label="Search input card">
      <div className="mb-5">
    ...
    <ul className="grid gap-3" aria-label="Menu search results">
      {results.map((item) => (
        <li key={`${item.source ?? 'api'}:${item.path}:${item.label}`}>
          <a className="glass focus-ring block min-w-0 rounded-2xl border border-[oklch(1_0_0/0.05)] bg-[oklch(0.20_0.02_265/0.25)] backdrop-blur-md p-4 transition-all duration-200 hover:border-[oklch(1_0_0/0.12)]" href={item.path}>
...
function SearchScopeCard({ scope, resultGroups, total }: { scope: SearchScope; resultGroups: string[]; total: number }) {
  return (
    <section className="glass rounded-3xl border border-[oklch(1_0_0/0.08)] bg-[oklch(0.16_0.02_265/0.35)] shadow-[0_8px_32px_oklch(0_0_0/0.4)] backdrop-blur-xl p-5 sm:p-6" aria-label="Search scope card">
      ...
      <ul className="mt-5 grid gap-2 text-sm text-text-muted">
        <li className="glass rounded-xl border border-[oklch(1_0_0/0.05)] bg-[oklch(0.20_0.02_265/0.25)] backdrop-blur-md p-3">
...
function SearchResultsCard({
  ...
  return (
    <section className="glass rounded-3xl border border-[oklch(1_0_0/0.08)] bg-[oklch(0.16_0.02_265/0.35)] shadow-[0_8px_32px_oklch(0_0_0/0.4)] backdrop-blur-xl p-5 sm:p-6" aria-label="Menu search results card">
      <div className="mb-4">
