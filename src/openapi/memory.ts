...
function fanoutExample(): Spec { return { query: 'confidence heat', strategy: 'reciprocal_rank_fusion', collections: ['bge-m3'], ranking: { confidenceWeight: 0.25, confidenceRerankingEnabled: true, confidenceSource: 'query-time-confidence' }, results: [{ ...searchResultExample(), fusedScore: 0.016393, rankingScore: 0.941, confidenceWeight: 0.25, matches: [{ collection: 'bge-m3', rank: 1, score: 0.92 }] }], errors: {}, cost: { vectorQueries: 1, estimatedUsd: 0 } }; }
